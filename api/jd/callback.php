...
$callback = _G('cfg','siteurl').'api/jd/callback.php';
...
$params["client_id"] = $memberconfig['passport_jd_appkey'];
$params["client_secret"] = $memberconfig['passport_jd_appsecret'];
$params["redirect_uri"] = $callback;
$url = 'https://oauth.taobao.com/token';
//https://auth.360buy.com/oauth/authorize?response_type=code&client_id=YOUR_CLIENT_ID&redirect_uri=YOUR_REGISTERED_REDIRECT_URI&state=YOUR_CUSTOM_CODE
...
if($token->access_token) {
    ...
    if(!$passport_id) {
        ...
        $sync = $user->login_passport($uid,'taobao',$passport_id);
    } else {
