...
function form_admin_city($select = null, $is_all = false) {
    $admin = _G('admin');
    $loader = _G('loader');
    ...
    $mycitys = $admin->mycitys ? $admin->mycitys : array();
    foreach($citys as $val) {
        if (! $is_all && !$admin->is_founder && ! in_array($val['aid'], $mycitys)) continue;
