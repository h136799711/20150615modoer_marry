...
class ms_chinese {
    ...
    function Convert($source_string='' ) {
        ...
        if(function_exists('iconv') && $lib_convert) {
            $this->config['source_lang']=='UTF8' && $this->config['source_lang']='UTF-8';
            $this->config['source_lang']=='GB2312' && $this->config['source_lang']='GBK';
            $this->config['target_lang']=='UTF8' && $this->config['target_lang']='UTF-8';
            $this->config['target_lang']=='GB2312' && $this->config['target_lang']='GBK';
        ...
        if(function_exists('mb_convert_encoding') && $lib_convert) {
            ...
            $this->config['target_lang']=='UTF8' && $this->config['target_lang']='UTF-8';
            $this->config['target_lang']=='GB2312' && $this->config['target_lang']='GBK';
            return mb_convert_encoding($this->SourceText, $this->config['target_lang'], $this->config['source_lang']);
        }
        $this->OpenTable();
