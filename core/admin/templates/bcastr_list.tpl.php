...
<form method="post" name="myform" action="<?=cpurl($module,$act)?>&">
    <div class="space">
        ...
        <center>
            ...
            <input type="button" value="增加图片" class="btn" onclick="jslocation('<?=cpurl($module,$act,'add')?>');" />
            <input type="button" value="删除所选" class="btn" onclick="easy_submit('myform', 'delete', 'bcastr_ids[]');" />&nbsp;
            <button type="button" onclick="jslocation('<?=cpurl($module,$act)?>');" class="btn">返回</button>
        </center>
    </div>
</form>
</div>