...
<div id="body">
    <div class="sub-menu">
        <div class="sub-menu-heading">词语过滤</div>
    </div>
    <div class="remind">
        <p>1. 新增词语过滤时，“替换为”处填写“<span class="font_1">{BLOCK}</span>”则为禁止提交，填写“<span class="font_1">{CHECK}</span>”则为手工审核，其他为替换值。</p>
        <p>2. 使用过多的词语过滤项，将会影响服务器效率。</p>
    </div>
