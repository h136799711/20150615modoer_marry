    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" trmouse="Y">
            ...
            <tr>
                ...
                <td><?=$val['tplname']?></td>
                <td><?=$val['cachetime']?></td>
                <td><a href="<?=cpurl($module,$act,'code',array('callid'=>$val['callid']))?>">查看代码</a></td>
            ...
            <tr class="altbg1">
                <td colspan="9">
                    ...
                    <button type="button" onclick="jslocation('<?=cpurl($module,$act,'add')?>')" class="btn2">新增函数调用</button>&nbsp;
                    <button type="button" onclick="jslocation('<?=cpurl($module,$act,'addsql')?>')" class="btn2">新增SQL调用</button>
                </td>
            </tr>
            <?} else {?>
