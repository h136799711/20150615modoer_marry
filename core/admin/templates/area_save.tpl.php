...
function map_mark(id, p1, p2) {
	...
	point1 = p1;
	point2 = p2;
	var url = Url('modoer/index/act/map/width/500/height/350/p1/'+p1+'/p2/'+p2);
	if(point1 != '' && point2 != '') {
		url += '&show=yes';
	}
	var html = '<iframe src="' + url + '" frameborder="0" scrolling="no" width="500" height="350" id="ifupmap_map"></iframe>';
	html += '<center><button type="button" id="mapbtn1" class="btn">标注坐标</button>&nbsp;';
	html += '<button type="button" id="mapbtn2" class="btn">确定</button></center>';
	dlgOpen('选择地图坐标点', html, 535);
	$('#mapbtn1').click(
		function() {
...
<div id="body">
    <div class="space">
        ...
        <tr>
            <td>
                1. Modoe旗舰版安装分级为：1级-城市，2级-区/地级县市，3级-街道/路口/商业区/地标；<br />
