...
<div class="sub-menu">
    ...
    <a href="<?=cpurl($module,$act)?>" class="sub-menu-item selected">菜单列表</a>
    <a href="<?=cpurl($module,$act,'add',array('parentid'=>$parentid))?>" class="sub-menu-item<?if($op=='add'):?> selected<?endif;?>">添加菜单</a>
</div>
