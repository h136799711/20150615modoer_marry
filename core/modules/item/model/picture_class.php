...
class msm_item_picture extends msm_item_itembase {
    ...
    function save($post, $multi = FALSE, $setthumb = FALSE) {
        ...
        if(!$imginfo) redirect('item_post_picture_lost');
    ...
    function upload() {
        ...
        $wtext = $this->subject ? $this->subject['name'] : $this->global['user']->username;
        $img->set_watermark_text(lang('item_picture_wtext',array($this->global['cfg']['watermark_text'], $wtext)));
