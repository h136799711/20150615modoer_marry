...
if(!defined('IN_ADMIN')) {
    $acts = array('mobile','manage','ajax','category','member','list','detail','pic','allpic','reviews',
		'top','tag','rss','search','album','albums','mtool','related','tops','taobaoke','map','batch_post','guestbook','about');
    !$_GET['act'] && $_GET['act'] = 'category';
