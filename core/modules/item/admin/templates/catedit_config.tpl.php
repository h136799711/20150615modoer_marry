...
<form method="post" action="<?=cpurl($module,$act,$op)?>">
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
            ...
            <?endif;?>
            <tr>
                <td class="altbg1"><strong>添加<?=$t_mod['item_name']?>时必须上传封面：</strong>前台用户在添加主题时，必须添加封面。</td>
                <td><?=form_bool('t_cfg[subject_add_thumb]', $t_cfg['subject_add_thumb'])?></td>
            </tr>
            ...
            <tr>
                <td class="altbg1"><strong>允许上传语音点评：</strong>开启语音点评后，在填写点评时，可以选择在线录音并上传点评（语音点评时，可以不填写点评内容）。</td>
                <td><?=form_bool('t_cfg[voice_review]', $t_cfg['voice_review'])?></td>
            </tr>
