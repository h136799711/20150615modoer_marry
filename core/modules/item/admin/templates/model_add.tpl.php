...
<form method="post" action="<?=cpurl($module,$act,$op)?>" enctype="multipart/form-data">
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li class="selected"><a href="javascript:;" onfocus="this.blur()">编辑模型</a></li>
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="altbg1"><strong>导入时遇同名属性组或标签组时自动跳过：</strong>当导入模型文件时，
                    遇到系统内部已存在的同名属性组和标签组时，自动跳过，不进行属性组和标签组的导入。</td>
                <td><?=form_bool('model_import_jump_sname',1)?></td>
            </tr>
            <?endif;?>
        </table>
        <center>
