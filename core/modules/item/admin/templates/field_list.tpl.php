...
<form method="post" action="<?=cpurl($module,$act,'',array('modelid'=>$_GET['modelid']))?>">
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li class="selected"><a href="javascript:;" onfocus="this.blur()">自定义字段管理</a></li>
            <li><a id="add_types" rel="add_types_box" href="javascript:;" onfocus="this.blur()"><span class="font_1">新建字段</span></a></li>
        </ul>
