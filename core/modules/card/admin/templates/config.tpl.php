...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr>
                <td class="altbg1"><strong>会员卡首页商户显示数量:</strong>设置会员卡首页每页显示加盟商家的数量。默认为每页显示10个。</td>
                <td><input name="modcfg[offset]" type="text" class="txtbox5" value="<?=$modcfg['offset']>0?$modcfg['offset']:10?>" /> 张</td>
            </tr>
        </table>
