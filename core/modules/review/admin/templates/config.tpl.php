...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li id="btn_config2"><a href="javascript:;" onclick="tabSelect(2,'config');" onfocus="this.blur()">显示配置</a></li>
            <li id="btn_config3"><a href="javascript:;" onclick="tabSelect(3,'config');" onfocus="this.blur()">点评分数设置</a></li>
            <li id="btn_config4"><a href="javascript:;" onclick="tabSelect(4,'config');" onfocus="this.blur()">精华点评设置</a></li>
        </ul>
