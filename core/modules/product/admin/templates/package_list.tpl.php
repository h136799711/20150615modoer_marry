        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" trmouse="Y">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div><a href="<?=url("product/detail/pid/$val[id]") ?>" target="_blank"><?=$val['name'] ?></a></div>
                    <div>
                ...
                <td>
                   ...
                   <!-- <div>评论：<a href="<?=cpurl('comment','comment_list','list',array('idtype'=>'product_package','id'=>$val['id'],'dosubmit'=>'yes'))?>"><?=$val['comments']?></a> 条</div>-->
                </td>
                <td>
