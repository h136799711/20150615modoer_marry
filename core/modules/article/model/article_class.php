...
class msm_article extends ms_model {
    ...
    function upload_thumb($pic) {
        ...
        $thumb_w = $this->modcfg['thumb_width'] ? (int) $this->modcfg['thumb_width'] : 200;
        $thumb_h = $this->modcfg['thumb_height'] ? (int) $this->modcfg['thumb_height'] : 125;
        if($thumb_w <= 0) $thumb_w = 200;
        if($thumb_h <= 0) $thumb_h = 150;
