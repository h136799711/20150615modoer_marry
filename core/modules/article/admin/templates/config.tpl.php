    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="modcfg[content_min]" value="<?=$modcfg['content_min']?>" class="txtbox5" />
                     - 
                    <input type="text" name="modcfg[content_max]" value="<?=$modcfg['content_max']?>" class="txtbox5" />
                </td>
            </tr>
            <tr>
                <td class="altbg1"><strong>文章封面缩略图尺寸：</strong>定义文章发布时，上传封面图片的缩略图尺寸（宽*高，默认200*150）</td>
                <td>
                    <input type="text" name="modcfg[thumb_width]" value="<?=$modcfg['thumb_width']>0?$modcfg['thumb_width']:200?>" class="txtbox5" />
                     * 
                    <input type="text" name="modcfg[thumb_height]" value="<?=$modcfg['thumb_height']>0?$modcfg['thumb_height']:150?>" class="txtbox5" />
                </td>
            </tr>
            <!--
            <tr>
