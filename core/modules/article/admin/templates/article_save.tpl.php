...
<form method="post" action="<?=cpurl($module,$act,'save')?>" name="postform" id="postform">
            ...
            <tr>
                ...
                <td>
                    <select name="city_id" id="city_id">
                        <?=form_admin_city($detail['city_id']);?>
                    </select>
    ...
    <center>
    <?if(DEBUG):?>
        <button type="submit"name="dosubmit"value='YES'class="btn">DEBUG 提交</button>&nbsp;
    <?endif;?>
        <button type="button" class="btn" onclick="$('#content').val(kd_content.html());ajaxPost('postform', '', 'article_save_succeed');">提交</button>&nbsp;
