...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr>
                <td class="altbg1" valign="top" width="45%"><div style="margin-left:20px;"><strong>特殊会员组使用期限:</strong>设置单次购买的使用期限，默认为 30 天</div></td>
                <td width="*">
            ...
            <tr>
                <td class="altbg1">
                    <strong>用户收货地址添加数量:</strong>限制用户收货地址添加数量，最大值20个
                </td>
                <td>
                    <input type="text" name="modcfg[address_num_limit]" value="<?=$modcfg['address_num_limit']>0?$modcfg['address_num_limit']:20?>" class="txtbox4" />&nbsp;个
                </td>
            </tr>
        </table>
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config2" style="display:none;">
            ...
            <tr>
                <td class="altbg1"><strong>启用推广注册:</strong>通过会员的推广连接注册，推广用户和被推广用户可以获得相应的积分进行奖励<br />
                    <span class="font_1">具体积分奖励，请到“会员模块-积分策略设置”页面进行设置</span></td>
                <td><?=form_bool('modcfg[invite_reg]',(bool)$modcfg['invite_reg'])?></td>
            </tr>
            <tr>
                <td class="altbg1"><strong>推广者每日最高允许推广注册人数</strong>限制推广者每日可推广注册的人数；0表示不限制</td>
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config3" style="display:none;">
            ...
            <tr>
                ...
                <td width="*">
                    <?=form_check('modcfg[passport_list][]', array(
                    'weibo'=>'新浪微博',
                    'qq'=>'腾讯QQ',
                    'taobao'=>'淘宝网',
                    'txweibo'=>'腾讯微博',
                ), $modcfg['passport_list'],'','&nbsp;')?>
                </td>
            </tr>
            ...
            <input type="hidden" name="modcfg[passport_txweibo_name]" value="txweibo">
            ...
            <tr>
                <td class="altbg1"><strong>腾讯QQ App ID</strong>
            ...
            <tr>
                <td class="altbg1"><strong>腾讯QQ App KEY:</strong>获取位置同上</td>
                <td>
            ...
            <tr class="altbg2"><td colspan="2"><center><b>腾讯微博</b></center></td></tr>
            <tr>
                <td class="altbg1"><strong>腾讯微博前台显示名称:</strong>在网站前台显示的名称</td>
                <td>
                    <?=form_input('modcfg[passport_txweibo_title]', $modcfg['passport_txweibo_title']?$modcfg['passport_txweibo_title']:'腾讯微博帐号', 'txtbox2')?>
                </td>
            </tr>
            <tr>
                <td class="altbg1"><strong>腾讯微博 App ID</strong>
                    在 http://dev.t.qq.com/ 登录申请获取
                </td>
                <td>
                    <?=form_input('modcfg[passport_txweibo_appid]', $modcfg['passport_txweibo_appid'], 'txtbox2')?>
                </td>
            </tr>
            <tr>
                <td class="altbg1"><strong>腾讯微博 App KEY:</strong>获取位置同上</td>
                <td>
                    <?=form_input('modcfg[passport_txweibo_appkey]', $modcfg['passport_txweibo_appkey'], 'txtbox2')?>
                </td>
            </tr>
        </table>
    </div>
