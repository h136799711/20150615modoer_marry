        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <select name="orderby">
                    ...
                    <option value="point1"<?=$_GET['orderby']=='point1'?' selected="selected"':''?>>金币</option>
                    <option value="rmb"<?=$_GET['orderby']=='rmb'?' selected="selected"':''?>>人民币</option>
    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" trmouse="Y">
            <tr class="altbg1">
                ...
                <td width="150">婚礼主页</td>
                <td width="70">操作</td>
            </tr>
            <? $SN =& $_G['loader']->model('space:new');$SA =& $_G['loader']->model('space:attend'); ?>
            <? if($total):?>
            ...
            <tr>
                ...
                <td>
                	<? $newspace = $SN->read($val['uid']);?>
                	<?if($newspace):?>
                	已开通(回复<?echo $SA->attend_count($val['uid']);?>)
                	<?else:?>
                	未开通
                	<?endif?>
                </td>
            ...
            <tr class="altbg1">
                ...
                <td colspan="10" class="right"><?=$multipage?></td>
            </tr>
            <? else: ?>
            <tr>
